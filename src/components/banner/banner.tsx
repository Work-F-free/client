...
export const BannerFC: FC = () => {
  return (
    <div className="h-[650px] md:h-[450px] relative overflow-hidden rounded">
      ...
      <img className="w-full object-cover object-center h-full absolute top-0 " src='/banner-bg.png' alt='coworka' />
      ...
      <div className='absolute h-full w-full z-10'>
        <div className='flex flex-col p-6 gap-4 h-full items-center justify-center  '>
          <Title text={'Если выбор коворкинга, то Coworka '} size="lg" className="font-semibold text-center text-white" />
          <CoworkingMainFilter />
        </div>
      </div>
    </div>
